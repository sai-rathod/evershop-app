...
export interface EvershopRequest extends ExpressRequest {
    ...
    loginCustomerWithEmail: (email: string, password: string, callback: (err: Error | null, customer?: any) => void) => Promise<void>;
    logoutCustomer: (callback: (err: Error | null) => void) => void;
    isCustomerLoggedIn: () => boolean;
    getCurrentCustomer: () => CurrentCustomer | null;
    loginUserWithEmail: (email: string, password: string, callback: (err: Error | null, user?: any) => void) => Promise<void>;
