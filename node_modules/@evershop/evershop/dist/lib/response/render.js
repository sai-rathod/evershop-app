...
function buildContextData(request, response) {
    ...
    const appConfig = getValueSync('appConfig', {
        ...
        pageMeta: pageMeta
    }, { request, response }, (value) => value && typeof value === 'object' && !Array.isArray(value));
...
function renderDevelopment(request, response) {
    ...
    const notFoundFile = ((_a = request.currentRoute) === null || _a === void 0 ? void 0 : _a.isAdmin)
        ? 'adminNotFound.js'
        : 'notFound.js';
    const langCode = ((_b = request.currentRoute) === null || _b === void 0 ? void 0 : _b.isAdmin) ? 'en' : language;
    response.send(`
...
function renderProduction(request, response) {
    ...
    const notFound = ((_a = request.currentRoute) === null || _a === void 0 ? void 0 : _a.isAdmin)
        ? adminNotFound
        : frontNotFound;
    ...
    import(pathToFileURL(serverIndexPath).toString())
        .then((module) => {
        const source = processPreloadImages(module.default(assets.js, cssList, safeContextValue, langCode));
