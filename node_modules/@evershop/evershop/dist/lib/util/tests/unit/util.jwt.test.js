...
describe('JWT Utility Functions', () => {
    ...
    describe('Integration Tests', () => {
        it('should support full token refresh flow', () => {
            ...
            const newAccessToken = generateToken({ customer: decodedRefresh.customer }, TOKEN_TYPES.CUSTOMER);
        ...
        it('should handle admin login/refresh flow', () => {
            ...
            const newAccessToken = generateToken({ user: verifiedRefresh.user }, TOKEN_TYPES.ADMIN);
...
//# sourceMappingURL=util.jwt.test.js.map