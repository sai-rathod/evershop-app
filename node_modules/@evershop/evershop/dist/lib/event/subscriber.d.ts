 ...
 * ```
 */
export type EventSubscriber<T extends EventName> = (data: EventDataRegistry[T]) => Promise<void> | void;
/**
 ...
 * ```
 */
export declare function createSubscriber<T extends EventName>(eventName: T, handler: EventSubscriber<T>): (data: EventDataRegistry[T]) => Promise<void>;
