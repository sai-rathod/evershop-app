                    ...
                    React.createElement(Area, { id: "couponGridFilter", noOuter: true, coreComponents: [
                            {
                                component: {
                                    default: () => {
                                        var _a;
                                        return (React.createElement(InputField, { name: "coupon", placeholder: "Search", defaultValue: (_a = currentFilters.find((f) => f.key === 'coupon')) === null || _a === void 0 ? void 0 : _a.value, onKeyPress: (e) => {
                                                var _a;
                                                // If the user press enter, we should submit the form
                                                if (e.key === 'Enter') {
                                                    const url = new URL(document.location);
                                                    const coupon = (_a = e.target) === null || _a === void 0 ? void 0 : _a.value;
                                                    if (coupon) {
            ...
            React.createElement("tbody", null,
                ...
                coupons.map((c) => (React.createElement("tr", { key: c.couponId },
                    React.createElement("td", null,
                        React.createElement("div", { className: "form-field mb-0" },
                            React.createElement("input", { type: "checkbox", checked: selectedRows.includes(c.uuid), onChange: (e) => {
                                    if (e.target.checked) {
                    ...
                    React.createElement(Area, { id: "couponGridRow", row: c, noOuter: true, selectedRows: selectedRows, setSelectedRows: setSelectedRows, coreComponents: [
                            ...
                            {
                                component: {
                                    default: () => { var _a; return React.createElement("td", null, ((_a = c.startDate) === null || _a === void 0 ? void 0 : _a.text) || '--'); }
                                },
                                sortOrder: 20
                            },
                            {
                                component: {
                                    default: () => { var _a; return React.createElement("td", null, ((_a = c.endDate) === null || _a === void 0 ? void 0 : _a.text) || '--'); }
                                },
                                sortOrder: 30
                            },
                            {
                                component: {
                                    default: ({ areaProps }) => (React.createElement(Status, { status: parseInt(c.status, 10) }))
                                },
                                sortOrder: 40
                            },
                            {
                                component: {
                                    default: ({ areaProps }) => React.createElement("td", null, c.usedTime)
                                },
                                sortOrder: 50
                            }
                        ] })))))),
