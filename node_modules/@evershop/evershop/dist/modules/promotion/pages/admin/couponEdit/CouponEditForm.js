...
export default function CouponEditForm({ action, gridUrl }) {
    return (React.createElement(Form, { method: "PATCH", action: action, submitBtn: false, id: "couponEditForm" },
        ...
        React.createElement(FormButtons, { cancelUrl: gridUrl, formId: "couponEditForm" })));
}
export const layout = {
    areaId: 'content',
    sortOrder: 10
...
`;
//# sourceMappingURL=CouponEditForm.js.map