...
export default function PaypalCaptureButton({ captureAPI, order: { paymentStatus, uuid, paymentMethod } }) {
    ...
    return (React.createElement(RenderIfTrue, { condition: paymentMethod === 'paypal' && paymentStatus.code === 'authorized' },
        React.createElement(Card.Session, null,
            React.createElement("div", { className: "flex justify-end" },
                React.createElement(Button, { title: "Capture", onAction: onAction, isLoading: isLoading })))));
}
export const layout = {
...
`;
//# sourceMappingURL=PaypalCaptureButton.js.map