        ...
        if (!order) {
            ...
            if (responseData.data.status === 'COMPLETED') {
                ...
                await insert('payment_transaction')
                    ...
                    amount: responseData.data.purchase_units[0].payments.authorizations[0]
                        .amount.value,
                    currency: responseData.data.purchase_units[0].payments.authorizations[0]
                        .amount.currency_code,
                    status: responseData.data.purchase_units[0].payments.authorizations[0]
                        .status,
...
//# sourceMappingURL=%5BbodyParser%5Dauthorize.js.map