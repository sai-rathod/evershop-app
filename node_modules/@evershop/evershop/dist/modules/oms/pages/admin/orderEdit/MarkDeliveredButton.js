...
export default function MarkDeliveredButton({ order: { orderId, shipmentStatus: { code }, shipment }, markDeliveredApi }) {
    if (!shipment || code === 'delivered') {
        return null;
    }
    else {
        return (React.createElement(Button, { title: "Mark Delivered", variant: "primary", onAction: async () => {
...
`;
//# sourceMappingURL=MarkDeliveredButton.js.map