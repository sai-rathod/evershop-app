...
export default function OrderSummary({ order: { orderId, coupon, shippingMethodName, paymentMethodName, totalQty, totalTaxAmount, discountAmount, grandTotal, subTotal, shippingFeeInclTax, currency, paymentStatus } }) {
    return (React.createElement(Card, { title: React.createElement("div", { className: "flex space-x-2" },
            React.createElement(Circle, { variant: paymentStatus.badge }),
            React.createElement("span", { className: "block self-center" }, `${paymentStatus.name || 'Unknown'} - ${paymentMethodName || 'Unknown'}`)) },
        React.createElement(Card.Session, null,
            React.createElement(Area, { id: "orderSummaryBlock", orderId: orderId, currency: currency, grandTotal: grandTotal, coupon: coupon, discountAmount: discountAmount, totalTaxAmount: totalTaxAmount, className: "summary-wrapper", coreComponents: [
                    {
        ...
        React.createElement(Area, { id: "orderPaymentActions" })));
}
