...
const SubmitButton = ({ formId }) => {
    ...
    return (React.createElement("div", { className: "form-submit-button flex border-t border-divider mt-4 pt-4 justify-between" },
        React.createElement(Button, { title: "SIGN IN", onAction: () => {
...
export default function LoginForm({ authUrl, dashboardUrl }) {
    ...
    return (React.createElement("div", { className: "admin-login-form" },
        React.createElement("div", { className: "flex items-center justify-center mb-7" },
        ...
        error && React.createElement("div", { className: "text-critical py-2" }, error),
        React.createElement(Form, { action: authUrl, method: "POST", id: "adminLoginForm", onSuccess: onSuccess, submitBtn: false },
            React.createElement(Area, { id: "adminLoginForm", coreComponents: [
                    {
                        component: {
                            default: (React.createElement(EmailField, { prefixIcon: React.createElement(EnvelopeIcon, { className: "h-5 w-5" }), label: "Email", name: "email", placeholder: "Email", required: true, validation: {
                    ...
                    {
                        component: {
                            default: (React.createElement(PasswordField, { prefixIcon: React.createElement(LockClosedIcon, { className: "h-5 w-5" }), label: "Password", name: "password", placeholder: "Password", required: true, validation: {
                    ...
                    {
                        component: {
                            default: React.createElement(SubmitButton, { formId: "adminLoginForm" })
                        },
                        sortOrder: 30
                    }
                ], noOuter: true }))));
