...
export default async function registerDefaultProductCollectionFilters() {
    ...
    const defaultFilters = [
        ...
        },
        {
            ...
            operation: ['eq', 'in', 'nin'],
            callback: (query, operation, value, currentFilters) => {
                query.andWhere('product.category_id', OPERATION_MAP[operation], ['in', 'nin'].includes(operation) ? value.split(',') : value);
                currentFilters.push({
                    key: 'cat',
                    operation,
                    value
...
//# sourceMappingURL=registerDefaultProductCollectionFilters.js.map