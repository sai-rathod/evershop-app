...
export class ProductCollection {
    ...
    async init(filters = [], isAdmin = false) {
        ...
        productCollectionFilters.forEach((filter) => {
            const check = filters &&
                filters.find((f) => f.key === filter.key && filter.operation.includes(f.operation));
            if (filter.key === '*' || check) {
                filter.callback.apply({ isAdmin }, [
                    this.baseQuery,
                    check === null || check === void 0 ? void 0 : check.operation,
                    check === null || check === void 0 ? void 0 : check.value,
                    currentFilters
                ]);
            }
        });
