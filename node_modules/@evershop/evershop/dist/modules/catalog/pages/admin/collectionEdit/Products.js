...
export default function Products({ collection: { code, addProductApi } }) {
    ...
    return (React.createElement(Card, { title: "Products", actions: [
        ...
        error && (React.createElement(Card.Session, null,
            React.createElement("span", { className: "text-critical" }, error.message))),
        data && (React.createElement(Modal, { title: "Add Products", onClose: modal.close, isOpen: modal.isOpen },
            React.createElement(ProductSelector, { onSelect: addProductFunction, selectedProducts: data.collection.products.items.map((p) => ({
                    sku: p.sku,
                    uuid: p.uuid,
            ...
            React.createElement("div", null,
                React.createElement("div", { className: "mb-5" },
                    React.createElement("div", { className: "form-field" },
                        React.createElement("input", { className: "", type: "text", value: keyword, placeholder: "Search products", onChange: (e) => {
                                setLoading(true);
                                setKeyword(e.target.value);
                            } }))),
                data && !loading && (React.createElement(React.Fragment, null,
                    data.collection.products.items.length === 0 && (React.createElement("div", null, "No product to display.")),
                    React.createElement("div", { className: "flex justify-between" },
                        React.createElement("div", null,
                            React.createElement("i", null,
                                data.collection.products.total,
                                " items")),
                        React.createElement("div", null, data.collection.products.total > 10 && (React.createElement("div", { className: "flex justify-between gap-2" },
                            page > 1 && (React.createElement("a", { className: "text-interactive", href: "#", onClick: (e) => {
                                    e.preventDefault();
                                    setPage(page - 1);
                                } }, "Previous")),
                            page < data.collection.products.total / 10 && (React.createElement("a", { className: "text-interactive", href: "#", onClick: (e) => {
                                    e.preventDefault();
                                    setPage(page + 1);
                                } }, "Next")))))),
                    React.createElement("div", { className: "divide-y" }, data.collection.products.items.map((p) => {
                        var _a, _b, _c;
                        return (React.createElement("div", { key: p.uuid, className: "flex justify-between py-2 border-divider items-center" },
                            React.createElement("div", { className: "flex justify-items-start gap-5" },
                                React.createElement("div", { className: "grid-thumbnail text-border border border-divider p-2 rounded flex justify-center w-10 h-10" },
                            ...
                            React.createElement("div", { className: "text-right" },
                                React.createElement(Button, { title: "Remove", variant: "danger", onAction: async () => {
