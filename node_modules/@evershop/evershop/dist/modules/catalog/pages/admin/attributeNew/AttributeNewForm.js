...
export default function AttributeNewForm({ action, gridUrl }) {
    return (React.createElement(Form, { action: action, method: "POST", id: "attributeNewForm", onSuccess: (response) => {
        ...
        React.createElement(FormButtons, { formId: "attributeNewForm", cancelUrl: gridUrl })));
}
export const layout = {
    areaId: 'content',
    sortOrder: 10
