...
export default async (request, response, next) => {
    ...
    try {
        ...
        if (product === null) {
            ...
            if (!get(product, 'variant_group_id') ||
                ...
                if (attributes.length > 0) {
                    ...
                    vsQuery
                        .innerJoin('product_inventory')
                        .on('p.product_id', '=', 'product_inventory.product_inventory_product_id');
                    vsQuery
                    ...
                    vsQuery
                        .andWhere('a.attribute_id', 'IN', attributes.map((a) => a.attribute_id))
