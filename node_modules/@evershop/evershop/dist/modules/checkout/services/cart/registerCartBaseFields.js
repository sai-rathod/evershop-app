        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    ...
                    if (!(addressData === null || addressData === void 0 ? void 0 : addressData.country)) {
                        return null;
                    }
            ...
            resolvers: [
                async function resolver(shippingMethod) {
                    ...
                    shippingMethodQuery
                        ...
                        .on('shipping_method.shipping_method_id', '=', 'shipping_zone_method.method_id');
                    shippingMethodQuery
            ...
            resolvers: [
                async function resolver() {
                    ...
                    if (priceIncludingTax === true) {
                        ...
                        return toPrice(this.getData('shipping_fee_excl_tax') +
...
//# sourceMappingURL=registerCartBaseFields.js.map