    ...
    const newFields = fields.concat([
        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    var _a;
                    return (_a = this.getData('uuid')) !== null && _a !== void 0 ? _a : uuidv4();
                }
            ]
        },
        {
        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    var _a;
                    const product = await this.getProduct();
                    return (_a = parseInt(product.group_id, 10)) !== null && _a !== void 0 ? _a : null;
                }
            ],
        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    var _a;
                    const product = await this.getProduct();
                    return (_a = product.name) !== null && _a !== void 0 ? _a : null;
                }
            ],
            dependencies: ['product_id']
        },
        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    var _a;
                    const product = await this.getProduct();
                    return (_a = parseFloat(product.weight)) !== null && _a !== void 0 ? _a : null;
                }
            ],
            dependencies: ['product_id']
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    var _a;
                    const product = await this.getProduct();
                    return (_a = product.tax_class) !== null && _a !== void 0 ? _a : null;
                }
            ],
            dependencies: ['product_id']
        },
        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    ...
                    return (_a = parseInt(qty, 10)) !== null && _a !== void 0 ? _a : null;
                }
            ]
        },
        {
        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    var _a;
                    const product = await this.getProduct();
                    return (_a = product.variant_group_id) !== null && _a !== void 0 ? _a : null;
                }
            ],
            dependencies: ['product_id']
        },
...
//# sourceMappingURL=registerCartItemBaseFields.js.map