...
export const getAvailableShippingMethods = async (cartId, country, province, postcode) => {
    ...
    const shippingAddress = await select()
        ...
        .load(pool);
    if (!country && !(shippingAddress === null || shippingAddress === void 0 ? void 0 : shippingAddress.country)) {
        return [];
    }
    ...
    if (province || (shippingAddress === null || shippingAddress === void 0 ? void 0 : shippingAddress.province)) {
        zoneQuery
            .where('shipping_zone_province.province', '=', province || (shippingAddress === null || shippingAddress === void 0 ? void 0 : shippingAddress.province))
            .or('shipping_zone_province.province', 'IS NULL', null);
    }
    else {
        zoneQuery.where('shipping_zone_province.province', 'IS NULL', null);
    }
    zoneQuery.andWhere('shipping_zone.country', '=', country || (shippingAddress === null || shippingAddress === void 0 ? void 0 : shippingAddress.country));
    ...
    methodsQuery
        ...
        .on('shipping_zone_method.method_id', '=', 'shipping_method.shipping_method_id');
    methodsQuery
    ...
    methods = methods.filter((method) => {
        ...
        if (method.condition_type === 'price') {
            return (toPrice(method.min) <= cart.sub_total &&
                cart.sub_total <= toPrice(method.max));
        }
        else if (method.condition_type === 'weight') {
            return (toPrice(method.min) <= cart.total_weight &&
...
//# sourceMappingURL=getAvailableShippingMethods.js.map