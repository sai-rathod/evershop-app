import { insert, startTransaction, commit, rollback, select, insertOnUpdate } from '@evershop/postgres-query-builder';
        ...
        switch (event.type) {
            ...
            case 'payment_intent.amount_capturable_updated': {
                ...
                await insertOnUpdate('payment_transaction', [
                    ...
                    transaction_id: paymentIntent.id,
                    transaction_type: 'online',
                    payment_action: paymentIntent.capture_method === 'manual'
                        ? 'authorize'
                        : 'capture'
                })
                    .execute(connection);
...
//# sourceMappingURL=%5BbodyJson%5Dwebhook.js.map