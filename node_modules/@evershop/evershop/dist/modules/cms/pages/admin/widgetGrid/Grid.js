                ...
                React.createElement(Area, { id: "widgetGridFilter", noOuter: true, coreComponents: [
                        {
                            component: {
                                default: () => {
                                    var _a;
                                    return (React.createElement(InputField, { name: "name", placeholder: "Search", defaultValue: (_a = currentFilters.find((f) => f.key === 'name')) === null || _a === void 0 ? void 0 : _a.value, onKeyPress: (e) => {
                                            var _a;
                                            // If the user press enter, we should submit the form
                                            if (e.key === 'Enter') {
                                                const url = new URL(document.location);
                                                const name = (_a = e.target) === null || _a === void 0 ? void 0 : _a.value;
                                                if (name) {
            ...
            React.createElement("tbody", null,
                ...
                items.map((w, i) => (React.createElement("tr", { key: i },
                    React.createElement("td", { style: { width: '2rem' } },
                        React.createElement("div", { className: "form-field mb-0" },
                            React.createElement("input", { type: "checkbox", checked: selectedRows.includes(w.uuid), onChange: (e) => {
                                    if (e.target.checked) {
                    ...
                    React.createElement(Area, { className: "", id: "widgetGridRow", row: w, noOuter: true, coreComponents: [
                            {
                                component: {
                                    default: () => React.createElement(Name, { url: w.editUrl, name: w.name })
                                },
                                sortOrder: 10
                            },
                            {
                            ...
                            {
                                component: {
                                    default: ({ areaProps }) => (React.createElement(Status, { status: parseInt(w.status, 10) }))
                                },
                                sortOrder: 20
                            }
                        ] })))))),
