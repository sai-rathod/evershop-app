...
export default {
    Query: {
        ...
        basicMenuWidget: async (_, { settings }, { pool }) => {
            const categories = [];
            const pages = [];
            const menus = (settings === null || settings === void 0 ? void 0 : settings.menus) || undefined;
            const isMain = [1, '1', 'true', true].includes(settings === null || settings === void 0 ? void 0 : settings.isMain) || false;
            if (!menus) {
                return { menus: [] };
            }
            ...
            return { menus: items, isMain, className: settings === null || settings === void 0 ? void 0 : settings.className };
        }
    },
    Widget: {
...
//# sourceMappingURL=Widget.resolvers.js.map