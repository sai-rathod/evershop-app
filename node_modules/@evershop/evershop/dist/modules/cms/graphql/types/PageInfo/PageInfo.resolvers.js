    ...
    PageInfo: {
        ...
        ogInfo: (root, args, context) => {
            ...
            return getValueSync('ogInfo', {
                ...
                twitterSite: get(context, 'pageInfo.ogInfo.twitterSite', getConfig('shop.name', 'Evershop')),
                twitterCreator: get(context, 'pageInfo.ogInfo.twitterCreator', getConfig('shop.name', 'Evershop')),
                twitterImage: get(context, 'pageInfo.ogInfo.twitterImage', image)
            }, context);
        }
    }
};
//# sourceMappingURL=PageInfo.resolvers.js.map