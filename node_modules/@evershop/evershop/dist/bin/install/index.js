...
async function install() {
    ...
    await writeFile(path.resolve(CONSTANTS.ROOTPATH, '.env'), `DB_HOST="${db.databaseHost}"
...
`);
    ...
    try {
        ...
        await insertOnUpdate('admin_user', ['email'])
            .given({
            status: 1,
            email: (adminUser === null || adminUser === void 0 ? void 0 : adminUser.email) || 'admin@evershop.io',
            password: passwordHash,
            full_name: (adminUser === null || adminUser === void 0 ? void 0 : adminUser.fullName) || 'Admin'
        })
            .execute(connection);
