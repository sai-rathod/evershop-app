...
export function Pagination({ total, limit, page }) {
    ...
    return (React.createElement("div", { className: "pagination flex px-5" },
        React.createElement("div", { className: "flex justify-between w-full space-x-2 mt-2 mb-2" },
            React.createElement("div", { className: "flex space-x-2 items-center" },
                ...
                React.createElement("div", { className: "limit" },
                    React.createElement("div", { className: "form-field flex items-center", style: { width: '4rem', marginBottom: '0' } },
                        React.createElement("input", { type: "number", onKeyDown: (e) => onKeyPressLimit(e), ref: limitInput }))),
                React.createElement("div", { className: "self-center" },
                ...
                React.createElement("div", { className: "current", style: { width: '5rem' } },
                    React.createElement("div", { className: "form-field mb-0" },
                        React.createElement("select", { onChange: (e) => {
                                onKeyPress(e);
                            } }, Array.from({ length: Math.ceil(total / limit) }, (_, i) => i + 1).map((item) => (React.createElement("option", { key: item, value: item }, item)))))),
