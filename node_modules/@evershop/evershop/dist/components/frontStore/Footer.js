...
export function Footer({ copyRight }) {
    return (React.createElement("footer", { className: "footer bg-gray-100 mt-24 pt-2.5 pb-2.5 border-t border-gray-300" },
        React.createElement(Area, { id: "footerTop", className: "footer__top" }),
        React.createElement("div", { className: "footer__middle flex justify-between items-center" },
            React.createElement(Area, { id: "footerMiddleLeft", className: "footer__middle__left" }),
            React.createElement(Area, { id: "footerMiddleCenter", className: "footer__middle__center" }),
            React.createElement(Area, { id: "footerMiddleRight", className: "footer__middle__right" })),
        React.createElement(Area, { id: "footerBottom", className: "footer__bottom", coreComponents: [
                {
                    component: {
